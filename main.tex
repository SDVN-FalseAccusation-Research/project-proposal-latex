...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{diagrams/single-accuser.jpeg}
    \caption{Single-Accuser Opportunistic Fabrication Attack Scenario}
    \label{fig:single_accuser}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{diagrams/Sybil-Amplified Consensus Flooding.png}
    \caption{Sybil-Amplified Consensus Flooding Attack Scenario}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{diagrams/Timing Based Accusations.png}
    \caption{Timing-Based Accusations During High-Noise Periods Attack Scenario}
    \label{fig:timing_based}
\end{figure}
