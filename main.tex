...
an attack, then the response is issued from the \textit{Mitigation and Feedback} block (Figure~\ref{fig:
simple_block}). The controllers execute the chosen response back in the field (e. g., isolating or limiting any
